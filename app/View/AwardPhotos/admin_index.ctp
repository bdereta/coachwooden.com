<div class="awardPhotos index">
	<h2 class="page_title"><?php echo __('Award Photos'); ?></h2>
	<div class="subnavbar">
	...
	<tr>
		<td><?php echo h($awardPhoto['AwardPhoto']['ordering_position']/10); ?>&nbsp;</td>
		<td><?php echo $this->Html->link('<i class="icon-arrow-up"></i>', array('action' => 'reorder_position', $awardPhoto['AwardPhoto']['id'], 'up'), array('escape' => false, 'class'=>'bambla_arrows')); ?>
  			<?php echo $this->Html->link('<i class="icon-arrow-down"></i>', array('action' => 'reorder_position', $awardPhoto['AwardPhoto']['id'], 'down'), array('escape' => false, 'class'=>'bambla_arrows')); ?>
  		</td>
		...
		<td nowrap class="actions">
			...
			<?php echo $this->Form->postLink('<i class="icon-remove"></i>', array('action' => 'delete', $awardPhoto['AwardPhoto']['id']), array('class'=>'btn btn-danger','escape' => false,'alt'=>'Delete','title'=>'Delete'), __('Are you sure you want to delete # %s?', $awardPhoto['AwardPhoto']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
