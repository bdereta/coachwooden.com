<div class="winners index">
	<h2 class="page_title"><?php echo __('Winners'); ?></h2>
	<div class="subnavbar">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('winner_category_id'); ?></th>
	...
	<tr>
		<td><?php echo h($winner['Winner']['id']); ?>&nbsp;</td>
		<td>
		...
		<td nowrap class="actions">
			...
			<?php echo $this->Form->postLink('<i class="icon-remove"></i>', array('action' => 'delete', $winner['Winner']['id']), array('class'=>'btn btn-danger','escape' => false,'alt'=>'Delete','title'=>'Delete'), __('Are you sure you want to delete # %s?', $winner['Winner']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
