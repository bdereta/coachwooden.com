<div class="pyramids index">
	<h2 class="page_title"><?php echo __('Pyramids'); ?></h2>
	<div class="subnavbar">
	...
	<tr>
		...
		<td nowrap class="actions">
			...
			<?php echo $this->Form->postLink('<i class="icon-remove"></i>', array('action' => 'delete', $pyramid['Pyramid']['id']), array('class'=>'btn btn-danger','escape' => false,'alt'=>'Delete','title'=>'Delete'), __('Are you sure you want to delete # %s?', $pyramid['Pyramid']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
