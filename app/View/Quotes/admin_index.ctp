<div class="quotes index">
	<h2 class="page_title"><?php echo __('Quotes'); ?></h2>
	<div class="subnavbar">
	...
	<tr>
		...
		<td nowrap class="actions">
			...
			<?php echo $this->Form->postLink('<i class="icon-remove"></i>', array('action' => 'delete', $quote['Quote']['id']), array('class'=>'btn btn-danger','escape' => false,'alt'=>'Delete','title'=>'Delete'), __('Are you sure you want to delete # %s?', $quote['Quote']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
