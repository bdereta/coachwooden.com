<form action="#" method="post">
	...
	<div class="login-fields">
		...
		<div class="login-actions">
			<div class="float_right inline"><?php echo $this->Html->link('<i class="icon-home"></i> Back to Site', array('controller' => 'StaticPages', 'action' => 'home'), array('class' => 'button btn btn-med','escape' => false)); ?></div>	
